...
void executeLoadAndStore() {
    ...
    cudaMalloc((void **)&deviceOutput, NUM_TO_STORE * sizeof(int));
    ...
    // 커널 실행
    load_and_store<<<gridSize, blockSize, sharedMemSize>>>(deviceInput, deviceOutput, NUM_ELEMENTS, NUM_TO_STORE);
